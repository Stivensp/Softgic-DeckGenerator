...
_D = {
    ...
    "section_number": {"left": 0.8,   "top": 0.8,  "width": 4.0,   "height": 2.0 },
    "section_title":  {"left": 0.8,   "top": 2.8,  "width": 11.3,  "height": 1.5 },
    "divider":        {"left": 0.8,   "top": 4.4,  "width": 3.5,   "height": 0.05},
    "tagline":        {"left": 0.8,   "top": 4.6,  "width": 11.3,  "height": 0.6 },
}
...
class SectionDividerRenderer(BaseLayoutRenderer):
    def render(self, slide: object, model: object, theme: ThemeModel) -> None:
        ...
        add_text_box(slide, p["left"], p["top"], p["width"], p["height"],  # type: ignore[arg-type]
                     model.section_number, f.family, f.size_stat, c.accent, bold=True, align=PP_ALIGN.LEFT)

        p = _p("section_title")
        section_title = truncate_text(model.section_title, lim.title_max_chars, "section_divider.section_title")
        add_text_box(slide, p["left"], p["top"], p["width"], p["height"],  # type: ignore[arg-type]
                     section_title, f.family, f.size_heading, c.text_light, bold=f.bold_headings)
        ...
        if model.tagline:
            p = _p("tagline")
            add_text_box(slide, p["left"], p["top"], p["width"], p["height"],  # type: ignore[arg-type]
                         model.tagline, f.family, f.size_body, c.text_muted, italic=True)
