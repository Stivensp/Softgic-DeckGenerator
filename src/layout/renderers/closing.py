...
_D = {
    ...
    "headline":          {"left": 0.8, "top": 1.3,  "width": 11.5,  "height": 1.2 },
    "divider":           {"left": 2.5, "top": 2.7,  "width": 8.33,  "height": 0.05},
    "contact_label":     {"left": 0.8, "top": 2.9,  "width": 12.0,  "height": 0.4 },
    "contact_name":      {"left": 0.8, "top": 3.35, "width": 4.0,   "height": 0.5 },
    "contact_email":     {"left": 4.8, "top": 3.35, "width": 4.0,   "height": 0.5 },
    "contact_phone":     {"left": 8.6, "top": 3.35, "width": 4.0,   "height": 0.5 },
    "cta_box":           {"left": 3.0, "top": 4.35, "width": 7.33,  "height": 0.75},
    "cta_text":          {"left": 3.1, "top": 4.45, "width": 7.13,  "height": 0.55},
}
...
class ClosingRenderer(BaseLayoutRenderer):
    def render(self, slide: object, model: object, theme: ThemeModel) -> None:
        ...
        add_text_box(slide, p["left"], p["top"], p["width"], p["height"], headline,  # type: ignore[arg-type]
                     f.family, f.size_heading, c.text_light, bold=f.bold_headings, align=PP_ALIGN.CENTER)
        ...
        if model.cta:
            ...
            add_text_box(slide, p["left"], p["top"], p["width"], p["height"], model.cta,  # type: ignore[arg-type]
                         f.family, f.size_body, c.primary, bold=True, align=PP_ALIGN.CENTER)
